...
const groups=[
 {id:'release',title:'Vydání a manifest',tests:[
  ['manifest',async()=>{const j=await json('../studio-manifest.json');return check(j.id==='activity-builder'&&j.version==='0.5.12','Manifest ACTIVA 0.5.12','ID nebo verze nesouhlasí.')}],
...
const result={schema:'activa-runtime-selftest-v1',version:'0.5.12',createdAt:'',tests:[]};

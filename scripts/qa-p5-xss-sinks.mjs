...
const report={schema:'ghrab-p5-xss-sink-audit-v1',appId:baseline.appId,counts,baseline:baseline.counts,csp,evidence,limitations:['This is a regression inventory, not proof that every HTML sink is safe.','Executable inline JavaScript has been removed from production pages; style-src unsafe-inline remains a documented UI compatibility exception.'],failures,status:failures.length?'failed':'passed'};
